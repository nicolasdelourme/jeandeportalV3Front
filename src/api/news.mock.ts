...
const VIDEO_1: NewsItem = {
  ...
  excerpt: "Analyse et conseils sur les métaux précieux par Nicolas Delourme.",
...
const VIDEO_2: NewsItem = {
  ...
  excerpt: "Point complet sur le marché des métaux précieux et perspectives.",
...
const VIDEO_3: NewsItem = {
  ...
  excerpt: "Stratégies d'investissement et analyse des marchés.",
