...
<template>
    <Card>
        <CardHeader>
            <CardTitle style="font-family: Roboto, sans-serif;">Changer le mot de passe</CardTitle>
                        ...
                        <FormControl>
                            <div class="relative">
                                ...
                                <Input :type="showCurrentPassword ? 'text' : 'password'" placeholder="••••••••"
                                    class="pl-10 pr-10" autocomplete="current-password" v-bind="componentField" />
                                <button type="button" @click="showCurrentPassword = !showCurrentPassword"
                                    class="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-400 hover:text-neutral-600">
                                    <FontAwesomeIcon v-if="showCurrentPassword && getIcon('eyeSlash')"
                        ...
                        <FormControl>
                            <div class="relative">
                                ...
                                <button type="button" @click="showNewPassword = !showNewPassword"
                                    class="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-400 hover:text-neutral-600">
                                    <FontAwesomeIcon v-if="showNewPassword && getIcon('eyeSlash')"
                                        :icon="getIcon('eyeSlash')" class="w-4 h-4" />
                                    <FontAwesomeIcon v-else-if="getIcon('eye')" :icon="getIcon('eye')" class="w-4 h-4" />
                                </button>
                            </div>
